		...
		if (action.equals("insert")) {
			...
			try {
				...
				for (int i = 0; i < list.size(); i++) {
					String s = list.get(i).getUser_id() + "_"+list.get(i).getEmp_id() + "_"+list.get(i).getUser_type() + "_"+list.get(i).getUsername() + "_"+list.get(i).getPassword() + "_"+list.get(i).getDate_time() + "_";
					stringList.add(s);
				}
