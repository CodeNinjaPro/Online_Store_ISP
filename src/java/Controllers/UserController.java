...
public class UserController{
	...
	public void Save(User data) throws Exception {
		con.getConnection();
		con.aud("INSERT INTO user(emp_id,user_type,username,password,date_time) values ('" + data.getEmp_id()+ "','" + data.getUser_type()+ "','" + data.getUsername()+ "','" + data.getPassword()+ "','" + data.getDate_time()+ "') " );
	}

	public void Update(User data) throws Exception {
		con.getConnection();
		con.aud("UPDATE user SET emp_id  = '" + data.getEmp_id()+ "',user_type  = '" + data.getUser_type()+ "',username  = '" + data.getUsername()+ "',password  = '" + data.getPassword()+ "',date_time  = '" + data.getDate_time()+ "' WHERE user_id = '" + data.getUser_id()+ "'");
	}
