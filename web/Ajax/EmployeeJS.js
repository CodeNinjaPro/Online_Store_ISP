...
function selectedRowToInput() {
    ...
    for (var i = 1; i < table.rows.length; i++) {
        table.rows[i].onclick = function () {
            ...
            document.getElementById("emp_id").value = this.cells[1].textContent;
            ...
            document.getElementById("contact_number").value = this.cells[5].textContent;
            document.getElementById("designation").value = this.cells[6].textContent;
...
function save() {
    ...
    var action = "insert";
    if (emp_id === "" || full_name === "" || address === "" || email === "" || contact_number === "" || designation === "" || date_time === "") {
        alert("Please Enter All Details")
    } else {
        $.ajax({
            url: 'EmployeeServlet',
            method: 'POST',
            data: {action: action, emp_id: emp_id, full_name: full_name, address: address, email: email, contact_number: contact_number, designation: designation, date_time: date_time},
...
function update() {
    ...
    } else if (emp_id === "" || full_name === "" || address === "" || email === "" || contact_number === "" || designation === "" || date_time === "") {
        alert("Please Enter All Details")
    } else {
        $.ajax({
            url: 'EmployeeServlet',
