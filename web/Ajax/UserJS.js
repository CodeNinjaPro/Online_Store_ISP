...
function save() {
    ...
    var action = "insert";
    if (user_id === "" || emp_id === "" || user_type === "" || username === "" || password === "" || date_time === "") {
        alert("Please Enter All Details")
    } else {
        $.ajax({
            url: 'UserServlet',
            method: 'POST',
            data: {action: action, user_id: user_id, emp_id: emp_id, user_type: user_type, username: username, password: password, date_time: date_time},
...
function update() {
    ...
    } else if (user_id === "" || emp_id === "" || user_type === "" || username === "" || password === "" || date_time === "") {
        alert("Please Enter All Details")
    } else {
        $.ajax({
            url: 'UserServlet',
